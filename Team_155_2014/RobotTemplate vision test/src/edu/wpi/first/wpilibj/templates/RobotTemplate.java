	...
	int verticalTargetCount, horizontalTargetCount;
        ...
        while (isAutonomous() && isEnabled()) {
            ...
            try {
                ...
                //ColorImage image = new RGBImage("/testImage5.jpg");		// get the sample image from the cRIO flash
                BinaryImage thresholdImage = image.thresholdHSV(80, 120, 230, 255, 130, 190);   // keep only green objects

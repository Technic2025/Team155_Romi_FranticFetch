...
public class RobotContainer {
  ...
  private Command generateRamseteCommand() {
    ...
    Trajectory Trajectory = TrajectoryGenerator.generateTrajectory(
       ...
       // new Pose2d(Units.inchesToMeters(27.0), Units.inchesToMeters(-9.0), new Rotation2d(Math.PI)),
        new Pose2d(Units.inchesToMeters(7.5), Units.inchesToMeters(-22.5), new Rotation2d(0)),
        List.of(
          new Translation2d(Units.inchesToMeters(33.0), Units.inchesToMeters(-33.0)),
          new Translation2d(Units.inchesToMeters(38.0), Units.inchesToMeters(-24.0))
        ),
        new Pose2d(Units.inchesToMeters(65.0), Units.inchesToMeters(-20.0), new Rotation2d(0)),
        config);
//transform the path
//Transform2d transform = new Pose2d(Units.inchesToMeters(0), Units.inchesToMeters(0),
...
//Trajectory newTrajectory = Trajectory.transformBy(transform);
    ...
    return new InstantCommand(() -> m_drivetrain.resetOdometry(Trajectory.getInitialPose()),
                                 m_drivetrain)
  ...
  public Command getArcadeDriveCommand() {
    return new ArcadeDrive(
      //m_drivetrain, () -> -m_controller.getRawAxis(1), () -> m_controller.getRawAxis(2)); //joystick
